import type { DiffEnvelope, EventEnvelope, PublishSummary, ReviewStatus, SnapshotEnvelope, Uuid } from "../types";
export type SyncEventTopic = "snapshot.applied" | "section.changed" | "section.committed" | "section.conflicted" | "review.status.updated" | "timeline.publish.summary" | "sync.telemetry";
...
export type SyncEventEnvelope<TTopic extends SyncEventTopic = SyncEventTopic> = EventEnvelope<TTopic, SyncEventPayloadMap[TTopic]>;
