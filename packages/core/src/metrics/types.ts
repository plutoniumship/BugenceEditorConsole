...
export type MetricResolver<TValue = unknown> = (
  context: MetricContext
) => Promise<MetricResult<TValue> | null | undefined> | MetricResult<TValue> | null | undefined;

export type MetricFormatter<TValue = unknown> = (
