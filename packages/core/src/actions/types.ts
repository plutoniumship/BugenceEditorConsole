...
export type ActionLoader<TParams = unknown, TContext extends ActionContext = ActionContext> =
  () => Promise<ActionModule<TParams, TContext>> | ActionModule<TParams, TContext>;
